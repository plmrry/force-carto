        ...
        nodes
          ...
          .forEach(quadNode => {
            ...
            if (l < r * r) {
              ...
              if (y === 0) (y = jiggle()), (l += y * y);
              l = Math.sqrt(l);
              /** Overlap as a percentage, times strength */
              l = (r - l) / l * strength;
              const quadNodeArea = Math.PI * quadNodeRadius * quadNodeRadius;
              /** Ratio of areas! */
              // r = quadNodeArea / (currentArea + quadNodeArea);
              r = 0.5
              // console.log({ currentArea, quadNodeArea, r })
              x *= l;
              node.vx += x * r;
              y *= l;
              node.vy += y * r;
